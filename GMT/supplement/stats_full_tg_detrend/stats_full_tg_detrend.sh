...
gmt psbasemap -K -R1/12/5.0/8.5 -JX6.25c/4c -X0.8c -Y1.9c -BWeSn+t"Root mean square error" -Bx2g2+l"Months after initialization" -By0.5g0.5 > $ps
for i in {1..10}
do
...
echo "1 5 a" | gmt pstext -D0.125c/0.125c -Gwhite -R -J -F+f9p,Hind-SemiBold+jLB -O -K >> $ps
